...
#form-wrapper {     
  ...
  .list-group {
    ...
    <a href="<?php echo base_url().'user/updateuserprofile'; ?>" class="list-group-item active"><i class="fa fa-question-circle"></i> <span>update profile</span></a>
...
<?php echo form_input(['name'=>'FullName','placeholder'=>'FullName','type'=>'text','class'=>'form-control','required'=>'true','value'=>$r['FullName']])  ?>
                </td></tr><tr><td>	
   <label class="h6" style="color: white;"> email</label>
<?php echo form_input(['name'=>'Email','placeholder'=>'Email','type'=>'email','class'=>'form-control','required'=>'true','value'=>$r['Email']])  ?>
 </td></tr><tr><td>
 <label class="h6" style="color: white;"> Address</label>
...
<label class="h6" style="color: white;"> Allergies</label>
<?php echo form_textarea(['name'=>'Allergies','placeholder'=>'If No Allergies Please Type No Allergies','type'=>'comments','class'=>'form-control','required'=>'true','value'=>$r['Allergies'],'cols'=>3,'rows'=>3])  ?>
    </td></tr><!--<tr><td>
<label class="h6" style="color: white;"> City</label>
<?php //echo form_input(['name'=>'City','placeholder'=>'City','type'=>'text','class'=>'form-control','required'=>'true','value'=>$r['City']])  ?>
 </td></tr>-->
