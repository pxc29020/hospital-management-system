...
<style>
 ...
 //Gender;  ?>
            <!---form open--><?php echo form_open('Admin/adminupdatedoctor')?>
                        ...
                        <div class="col-sm-9">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="Name" name="Name" value="<?php echo $r->Name; ?>" />
                            </div>
                        </div>
...
?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="PhoneNo" name="PhoneNo" value="<?php echo $r->PhoneNo; ?>"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="Allergies" class="col-sm-3 control-label">AboutDoctor:</label>
                            <div class="col-sm-9">
                                <textarea id="AboutDoctor" rows="3" cols="20" name="AboutDoctor"><?php echo $r->AboutDoctor; ?></textarea>
                            </div>
                        </div>
