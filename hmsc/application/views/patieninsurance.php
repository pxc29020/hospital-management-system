...
.list-group {
  ...
  <a href="<?php echo base_url().'doctor/viewdoctorappointments'; ?>" class="list-group-item active"><i class="fa fa-credit-card"></i> <span>view appointment</span></a>
    ...
    $id  = $this->uri->segment(3);
       //print_r($id);
       $history = $this->Users_model->patientinsurance($id);
      // print_r($history);
        ?>
  <div id="form-wrapper">    
  <p class="h2" style="color:white;">View Patient Insurance Policy</p>
      ...
      <table class="table table-bordered">
        <thead>
          <tr>
           ...
           <th style="width:20px">Policy Number</th>
       <th style="width:20px">About Policy</th>
         ...
         {  
          ...
          <tr>
            ...
            <td><?php echo $row['FullName'];?></td>
             ...
             <td><?php echo $row['AboutPolicy'];?></td>
