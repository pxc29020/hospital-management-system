...
<strong>Warning!</strong> <?php echo $this->session->flashdata('warning'); } ?>
        ...
        <?php
     $doctors = $this->Users_model->get_inactivedoctors(); 
   // print_r($doctors);
   ...
   <h2>Manage Doctors</h2>
     ...
     <th style="width:20px">Gender</th>
           ...
           <!-- <th style="width:20px">Active</th>-->
            <th style="width:20px">Delete Doctor permanently</th>  
             <th style="width:20px">Make Doctor active </th>  
    ...
    <!-- <td><?php echo $row->Active ?></td>-->
          ...
          <td><a href="<?php echo base_url() . 'Admin/deletedoctor/' . $row->Id ?>" ><span class="glyphicon glyphicon glyphicon-refresh"></span> Delete user permanently</a></td>
         
            <td><a href="<?php echo base_url() . 'Admin/activedoctor/' . $row->Id ?>" ><span class="glyphicon glyphicon glyphicon-refresh"></span> Make Doctor active </a></td>
          </tr>
          <?php }  
         ?>  
        </tbody>
