...
<body>
    ...
    <div id="form-wrapper">
        <p class="h1" style="color:white;">Doctor Login</p>
	<?php echo form_open('Login/CheckDoctorAuthentication');?>
        ...
        <a href="<?php echo base_url().'doctor/DoctorLoginpage'; ?>" class="close" data-dismiss="alert">&times;</a>
...
<?php echo form_input(['name'=>'Password','placeholder'=>'Password','type'=>'password','class'=>'form-control','required'=>'true'])  ?>
    ...
    <p class="h3" style="color:white;">d@d.com and admin123</p>
